...
- Created your own repository using the [actions/importer-labs](https://github.com/actions/importer-labs) as a template
- Opened this repository in a new codespace
...
## How to update GitHub Actions Importer 
...
```
echo $GITHUB_PAT | gh actions-importer update --username $GITHUB_USERNAME --password-stdin
```
...
Next, we’ll tackle GitHub Actions Importer's commands and review what it cannot migrate automatically. 
